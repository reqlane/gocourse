...
func main() {
	...
	parsedTime2, _ := time.Parse("06-1-2", "20-5-1")            // Mon Jan 2 2006 15:04:05 MST 2006
	parsedTime3, _ := time.Parse("06-1-2 15-04", "20-5-1 8-03") // Mon Jan 2 2006 15:04:05 MST 2006
	...
	// Formatting time
	t := time.Now()
	fmt.Println("Formatted time:", t.Format("Jan 06-01-02 15-04-05"))
	...
	// Convert this to specific timezone
	tLocal := t.In(loc)
